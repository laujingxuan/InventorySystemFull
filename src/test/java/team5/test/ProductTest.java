...
//	}
	...
	public void createFixsets() {
		...
		Product tyre = productRepo.findById((long)10).get();
		Product suspension = productRepo.findById((long)11).get();
		Product pedal = productRepo.findById((long)12).get();
		Product engine = productRepo.findById((long)13).get();
