...
public class ProductTest {
	...
	public void saveProduct() {
		productRepo.save(new Product(2345,"Collision Cart","The original high quality, low friction dynamics carts made from durable machined aluminum.",
									"Type A","Blue",200,"Category A", 2000 ,  3000, 1200, 2, 2, "12345" , srepo.findById((long)5).get(), 1, 1));
		productRepo.save(new Product(3432,"Large Table Clamp","Can attach to tables, shelves, or other boards up to 10 cm thick.",
				"Type B","Black",200,"Category B", 2500 ,  3000, 1260, 3, 2, "12345", srepo.findById((long)4).get() , 1, 1));
		//productRepo.save(new Product(5432,"Tension Protractor","ME-6855","Type C","White",500,"Category C", 8000 ,  3500, 1240, 6, 4, "2314" , 1, 4));
		
		productRepo.save(new Product(2345,"Collision Cart","The original high quality, low friction dynamics carts made from durable machined aluminum.",
									"Type A","Blue",200,"Category A", 2000 ,  3000, 1200, 2, 2, "12345", srepo.findById((long)3).get() , 8, 3));
		productRepo.save(new Product(3432,"Large Table Clamp","Can attach to tables, shelves, or other boards up to 10 cm thick.",
				"Type B","Black",200,"Category B", 2500 ,  3000, 1260, 3, 2, "12345", srepo.findById((long)5).get() , 8, 5));
		//productRepo.save(new Product(5432,"Tension Protractor","ME-6855","Type C","White",500,"Category C", 8000 ,  3500, 1240, 6, 4, "2314", srepo.findById((long)3).get() , 7, 4));
		productRepo.save(new Product(3452,"Jeep wheel","The best wheel for jeep.",
				"Type A","Black",200,"Category A", 2000 ,  3000, 1200, 2, 2, "12345", srepo.findById((long)4).get() , 5, 2));
		productRepo.save(new Product(3433,"Large Table Clamp","Can attach to tables, shelves, or other boards up to 10 cm thick.",
				"Type B","Black",200,"Category B", 2500 ,  3000, 1260, 3, 2, "12345", srepo.findById((long)3).get() , 6, 3));
		productRepo.save(new Product(5433,"Tension Protractor","ME-6855","Type C","White",500,"Category C", 8000 ,  3500, 1240, 6, 4, "2314", srepo.findById((long)5).get(), 10, 4));
		productRepo.save(new Product(1000,"Tyre","ME-6855","Type C","Black",500,"Category C", 8000 ,  3500, 1240, 6, 4, "2314", srepo.findById((long)4).get() , 10, 4));
		productRepo.save(new Product(1001,"Suspension","ME-6855","Type C","Silver",500,"Category B", 5000 ,  2000, 1500, 6, 4, "2314", srepo.findById((long)3).get() , 10, 4));
		productRepo.save(new Product(1002,"Pedal","ME-6855","Type C","Gold",500,"Category B", 5000 ,  2000, 1500, 6, 4, "2314", srepo.findById((long)5).get() , 10, 4));
		productRepo.save(new Product(1003,"Engine","ME-6855","Type C","Silver",500,"Category B", 5000 ,  2000, 1500, 6, 4, "2314", srepo.findById((long)4).get() , 10, 4));
	 ...
	 * productRepo.findById((long)2); Product third = productRepo.findById((long)3);
	 * SimpleDateFormat formatter = new SimpleDateFormat("dd-MM-yyyy"); Date fDate =
	 * formatter.parse("01-12-2020"); Date sDate = formatter.parse("03-12-2020");
	 * Date tDate = formatter.parse("05-12-2020"); User admin1 =
	 * urepo.findById((long)1).get(); UsageRecord oneR = usageRepo.save(new
	 * UsageRecord("john","SAA1235", fDate, admin1)); UsageRecord secondR =
	 * usageRepo.save(new UsageRecord("Mary","SAB2345", sDate, admin1));
	 * usageRepo.save(new UsageRecord("Peter","SAC3456", tDate, admin1));
	 * strepo.save(new StockTransaction(first,oneR,3)); strepo.save(new
	 * StockTransaction(second,oneR,3)); strepo.save(new
	 * StockTransaction(third,secondR,3)); strepo.save(new
	 * StockTransaction(first,secondR,3)); strepo.save(new
	 * StockTransaction(third,oneR,3)); }
	 */
//	@Test
